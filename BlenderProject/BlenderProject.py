...
dict = {'object': Object, 'type': Type, 'material': Material, 'material quantity': MatSum}
df = pd.DataFrame(dict)
# save to csv
df.to_csv('/Users/yuanqihu/Library/CloudStorage/OneDrive-PennO365/2025Fall/EDUC5913/MyEDUC-repo/BlenderProject/content_table.csv')

print("======================================")
df = pd.read_csv('/Users/yuanqihu/Library/CloudStorage/OneDrive-PennO365/2025Fall/EDUC5913/MyEDUC-repo/BlenderProject/content_table.csv')
