bl_info = {
    "name": "Material & Texture Cleaner + CSV Export",
    "author": "Yuanqi Hu",
    "version": (1, 0, 0),
    "blender": (4, 5, 3),  # 按实际使用的最低 Blender 版本改
    "location": "3D View > N 面板 > My Cleaner",
    "description": "Export objects/materials to CSV and clean unused materials/textures.",
    "warning": "",
    "category": "Object",
}
